...
public enum ApiError {
    ...
    ENTITY_NOT_FOUND_ERROR("E100003", "Entity not found.", HttpStatus.NOT_FOUND),
    ENTITY_VALIDATION_FAILED_ERROR("E100004", "Entity validation failed.", HttpStatus.BAD_REQUEST),
    TRANSACTION_FAILED_ERROR("E100005", "Transaction failed.", HttpStatus.INTERNAL_SERVER_ERROR);
